...
var testComposites = map[string]result{
	`[`:             {nil, lexerError{Type: "syntax", Err: expectedError{Expected: "array element", Got: "end of file"}}},
	`[ ]`:           {_array{}, nil},
	`[ "V"`:         {nil, lexerError{Type: "reader", Err: io.ErrUnexpectedEOF}},
	`[ "V" ]`:       {_array{"V"}, nil},
	`[ "V" ,`:       {nil, lexerError{Type: "syntax", Err: expectedError{Expected: "array element", Got: "end of file"}}},
	`[ "V" , ]`:     {_array{"V"}, nil},
	`[ "V" , "X"`:   {nil, lexerError{Type: "reader", Err: io.ErrUnexpectedEOF}},
	`[ "V" , "X"]`:  {_array{"V", "X"}, nil},
	`[ "V" , "X",]`: {_array{"V", "X"}, nil},
	`(`:             {nil, lexerError{Type: "syntax", Err: expectedError{Expected: "map entry key", Got: "end of file"}}},
	`( )`:           {_map{}, nil},
	...
	`( "K" : "V" )`:        {_map{"K": "V"}, nil},
	`( "K" : "V" ,`:        {nil, lexerError{Type: "syntax", Err: expectedError{Expected: "map entry key", Got: "end of file"}}},
	`( "K" : "V" , )`:      {_map{"K": "V"}, nil},
	...
	`( "K" : "V" ,"X":"X",`:  {nil, lexerError{Type: "syntax", Err: expectedError{Expected: "map entry key", Got: "end of file"}}},
	`( "K" : "V" ,"X":"X",)`: {_map{"K": "V", "X": "X"}, nil},
	`{`:                      {nil, lexerError{Type: "syntax", Err: expectedError{Expected: "struct field name", Got: "end of file"}}},
	`{ }`:                    {_struct{}, nil},
	...
	`{ I : "V" }`:        {_struct{"I": "V"}, nil},
	`{ I : "V" ,`:        {nil, lexerError{Type: "syntax", Err: expectedError{Expected: "struct field name", Got: "end of file"}}},
	`{ I : "V" , }`:      {_struct{"I": "V"}, nil},
	...
	`{ I : "V" ,X:"X",`:  {nil, lexerError{Type: "syntax", Err: expectedError{Expected: "struct field name", Got: "end of file"}}},
	`{ I : "V" ,X:"X",}`: {_struct{"I": "V", "X": "X"}, nil},
}
